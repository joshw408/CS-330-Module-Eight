...
void SceneManager::DefineObjectMaterials()
{
	...
	// a neutral material for the white objects in the scene
	OBJECT_MATERIAL matteWhite;
	matteWhite.diffuseColor = glm::vec3(1.0f, 1.0f, 1.0f);
	matteWhite.specularColor = glm::vec3(0.25f, 0.25f, 0.25f);
	matteWhite.shininess = 16.0f;
	matteWhite.tag = "matteWhite";
	m_objectMaterials.push_back(matteWhite);

	// glossy white
	OBJECT_MATERIAL glossyWhite;
	glossyWhite.diffuseColor = glm::vec3(1.0f, 1.0f, 1.0f);
	glossyWhite.specularColor = glm::vec3(0.75f, 0.75f, 0.75f);
	glossyWhite.shininess = 64.0f;
	glossyWhite.tag = "glossyWhite";
	m_objectMaterials.push_back(glossyWhite);
}
...
void SceneManager::SetupSceneLights()
{
	...
	// ------------------------------------------------------------
	// Point Light 0 (White) - must be active in this shader
	// ------------------------------------------------------------
	...
	m_pShaderManager->setVec3Value("pointLights[0].diffuse", glm::vec3(0.85f, 0.85f, 0.85f));
	m_pShaderManager->setVec3Value("pointLights[0].specular", glm::vec3(1.00f, 1.00f, 1.00f));
	m_pShaderManager->setBoolValue("pointLights[0].bActive", true);

	// ------------------------------------------------------------
	// Point Light 1 (Blue) - must be active in this shader
	// ------------------------------------------------------------
	m_pShaderManager->setVec3Value("pointLights[1].position", glm::vec3(-6.0f, 5.0f, 4.0f));
	m_pShaderManager->setVec3Value("pointLights[1].ambient", glm::vec3(0.01f, 0.01f, 0.03f));
	m_pShaderManager->setVec3Value("pointLights[1].diffuse", glm::vec3(0.10f, 0.20f, 0.95f));
	m_pShaderManager->setVec3Value("pointLights[1].specular", glm::vec3(0.10f, 0.20f, 0.95f));
	m_pShaderManager->setBoolValue("pointLights[1].bActive", true);

	// ------------------------------------------------------------
	// Ensure other lights are disabled so they don't affect grading
	// ------------------------------------------------------------
...
void SceneManager::RenderScene()
{
	...
	// set the material properties used by the lighting shader
