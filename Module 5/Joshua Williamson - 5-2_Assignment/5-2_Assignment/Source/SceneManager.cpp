...
void SceneManager::LoadSceneTextures()
{
	...
	CreateGLTexture("textures/sandstone.jpg", "sandstone");
	CreateGLTexture("textures/stone.jpg", "stone");
	CreateGLTexture("textures/brass.jpg", "brass");
	CreateGLTexture("textures/zinc.jpg", "zinc");
...
void SceneManager::RenderScene()
{
	...
	// red cylinder -> sandstone texture
	SetShaderTexture("sandstone");
